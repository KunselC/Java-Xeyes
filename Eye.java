...
public class Eye {
    ...
    public double findX (double slope, int deltaX) {
        ...
        // can calculate that...) As slope becomes very large, the offset will approach
        // 0.
    ...
    // findY calculates the new vertical positon of the pupil, at most vertDist away
    // from eye center
...
public boolean inEye(int mouseX, int mouseY) {
    ...
    // public void center(int clickX, int clickY){
    //     if(inEye(clickX, clickY)){
    //         pupilX = eyeCenterX;
    //         pupilY = eyeCenterY;}
    // }
